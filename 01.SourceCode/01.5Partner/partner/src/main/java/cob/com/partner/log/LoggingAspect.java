...
import cob.com.partner.log.models.AddLogDetailInfo;
import cob.com.partner.log.models.AddLogInfo;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* cob.com.partner.ws.rest.*.*(..))")
	...
	public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		bodyMsg = Arrays.toString(joinPoint.getArgs());
		info.set_arguments(bodyMsg);
    ...
    public void logAfterThrowingAllMethods(Throwable ex) throws Throwable  {
		...
		testApiDetail.set_detail(ex.getMessage() + "-Body:" + LoggingAspect.bodyMsg);
		String timeStamp = new SimpleDateFormat("yyyyMMdd").format(Calendar.getInstance().getTime());
