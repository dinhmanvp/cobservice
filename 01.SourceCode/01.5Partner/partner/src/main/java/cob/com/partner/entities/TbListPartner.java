 ...
 */
@Entity
@Table(name = "tb_listpartners")
public class TbListPartner implements Serializable {
	...
	@Id
	@Column(name = "n_id")
	@SequenceGenerator(name = "TbListpartner_sequence", sequenceName = "tb_listpartners_n_id_seq", allocationSize = 1, initialValue = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TbListpartner_sequence")
	private Integer nId;
