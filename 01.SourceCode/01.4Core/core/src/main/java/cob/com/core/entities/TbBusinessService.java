 ...
 */
@Entity
@Table(name = "tb_business_services")
@NamedQuery(name = "TbBusinessService.findAll", query = "SELECT t FROM TbBusinessService t")
public class TbBusinessService implements Serializable {
