...
import cob.com.core.log.models.AddLogDetailInfo;
import cob.com.core.log.models.AddLogInfo;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* cob.com.core.ws.rest.*.*(..))")
