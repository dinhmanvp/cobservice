...
import cob.com.accounts.log.models.AddLogDetailInfo;
import cob.com.accounts.log.models.AddLogInfo;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* cob.com.accounts.ws.rest.*.*(..))")
