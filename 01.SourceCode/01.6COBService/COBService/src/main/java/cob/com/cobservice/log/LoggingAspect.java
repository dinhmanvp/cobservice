package cob.com.cobservice.log;
...
import cob.com.cobservice.log.models.AddLogDetailInfo;
import cob.com.cobservice.log.models.AddLogInfo;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* cob.com.cobservice.ws.rest.*.*(..))")
