...
import cob.com.finance.log.models.AddLogDetailInfo;
import cob.com.finance.log.models.AddLogInfo;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* cob.com.finance.ws.rest.*.*(..))")
