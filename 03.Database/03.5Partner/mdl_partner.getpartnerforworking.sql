...
DELIMITER //
CREATE OR REPLACE FUNCTION mdl_partner.getpartnerforworking(userid TEXT, languagecode TEXT, fromDate TEXT, toDate TEXT)
RETURNS TABLE(
	...
	s_my_business_id mdl_account.tb_my_business.s_my_business_id%TYPE
)
AS $$
BEGIN		
	return query
	...
	GROUP BY ls.s_partner_id, s_group_business_name,mybiz.s_my_business_id ;
